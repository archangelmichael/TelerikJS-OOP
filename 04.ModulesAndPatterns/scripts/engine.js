...
var Engine = (function (container) {
    ...
    var drawer = Drawer;
    var snakeScore = new Score(WIDTH, HEIGHT);
    var snake;
    ...
    function startGame() {
        ...
        stones = [];
        snake = new Snake.Snake(40, 15 * 20, 10, 1);
        score = 0;
        level = 1;

        window.clearInterval(appleIntervalID);
        ...
        appleIntervalID = window.setInterval(randomApple, 2000);
    }
    ...
    function randomApple() {
        ...
        window.clearInterval(appleIntervalID);
        appleIntervalID = window.setInterval(randomApple, 10000);
    }
    ...
    function generateStones(stones) {
        var numberOfStones = random(30, 45);
